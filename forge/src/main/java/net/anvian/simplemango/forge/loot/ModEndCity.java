...
public final class ModEndCity extends LootModifier {
    public static final Supplier<Codec<ModEndCity>> CODEC =
            Suppliers.memoize(() -> RecordCodecBuilder.create(instance -> codecStart(instance)
                    ...
                    .apply(instance, ModEndCity::new)));
    private final Item item;

    private ModEndCity(LootItemCondition[] conditions, Item item) {
        super(conditions);
        this.item = item;
    }
