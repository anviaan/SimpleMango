...
public final class ModRuinedPortal extends LootModifier {
    public static final Supplier<Codec<ModRuinedPortal>> CODEC =
            Suppliers.memoize(() -> RecordCodecBuilder.create(instance -> codecStart(instance)
                    ...
                    .apply(instance, ModRuinedPortal::new)));
    private final Item item;

    private ModRuinedPortal(LootItemCondition[] conditions, Item item) {
        super(conditions);
        this.item = item;
    }
