...
public class ModFlammableRotadedPillarBlock extends RotatedPillarBlock {
    public ModFlammableRotadedPillarBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public BlockState getToolModifiedState(BlockState state, Level world, BlockPos pos, Player player,
        ...
        if(stack.getItem() instanceof AxeItem) {
            ...
            if(state.is(ModBlocks.MANGO_WOOD.get())) {
                return ModBlocks.STRIPPED_MANGO_WOOD.get().defaultBlockState().setValue(AXIS, state.getValue(AXIS));
            }
        }
